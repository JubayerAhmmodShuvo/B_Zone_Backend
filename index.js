...
mongoose.connect('mongodb+srv://book_catalog:Lpb6OTXhWhRhR6WN@cluster0.ybq2s4f.mongodb.net/book_catalog?retryWrites=true&w=majority', {
...
const JWT_SECRET = '4df43b5abfd4eb739ed96cb864c1256efeeb47647a9a48b890daa64d2c020a7890f2e1e7fbd573180179ceee6bd02a1d9a8c0bb1a40a59c5f6d59bad777d7b61';
...
app.post('/api/readinglist/:bookId',verifyJWT, async (req, res) => {
  try {
    ...
    const existingReadingListBook = await ReadingList.findOne({ book: book._id });
